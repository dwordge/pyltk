...
def encode_PerAntennaAirProtocol(par):
    ...
    for x in ProtocolID:
        data += struct.pack('!B', AirProtocols_Name2Type[x])
...
class CUSTOM_MESSAGE(LLRPMessage):
    def __init__(self):
        self['CUSTOM_MESSAGE'] = {}
        self['CUSTOM_MESSAGE']['Type'] = 1023
        self['CUSTOM_MESSAGE']['ID'] = 1


class GET_READER_CAPABILITIES(LLRPMessage):
    def __init__(self):
        self['GET_READER_CAPABILITIES'] = {}
        self['GET_READER_CAPABILITIES']['Type'] = 1
        self['GET_READER_CAPABILITIES']['ID'] = 1


class GET_READER_CAPABILITIES_RESPONSE(LLRPMessage):
    def __init__(self):
        self['GET_READER_CAPABILITIES_RESPONSE'] = {}
        self['GET_READER_CAPABILITIES_RESPONSE']['Type'] = 11
        self['GET_READER_CAPABILITIES_RESPONSE']['ID'] = 1


class ADD_ROSPEC(LLRPMessage):
    def __init__(self):
        self['ADD_ROSPEC'] = {}
        self['ADD_ROSPEC']['Type'] = 20
        self['ADD_ROSPEC']['ID'] = 1


class ADD_ROSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['ADD_ROSPEC_RESPONSE'] = {}
        self['ADD_ROSPEC_RESPONSE']['Type'] = 30
        self['ADD_ROSPEC_RESPONSE']['ID'] = 1


class DELETE_ROSPEC(LLRPMessage):
    def __init__(self):
        self['DELETE_ROSPEC'] = {}
        self['DELETE_ROSPEC']['Type'] = 21
        self['DELETE_ROSPEC']['ID'] = 1


class DELETE_ROSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['DELETE_ROSPEC_RESPONSE'] = {}
        self['DELETE_ROSPEC_RESPONSE']['Type'] = 31
        self['DELETE_ROSPEC_RESPONSE']['ID'] = 1


class START_ROSPEC(LLRPMessage):
    def __init__(self):
        self['START_ROSPEC'] = {}
        self['START_ROSPEC']['Type'] = 22
        self['START_ROSPEC']['ID'] = 1


class START_ROSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['START_ROSPEC_RESPONSE'] = {}
        self['START_ROSPEC_RESPONSE']['Type'] = 32
        self['START_ROSPEC_RESPONSE']['ID'] = 1


class STOP_ROSPEC(LLRPMessage):
    def __init__(self):
        self['STOP_ROSPEC'] = {}
        self['STOP_ROSPEC']['Type'] = 23
        self['STOP_ROSPEC']['ID'] = 1


class STOP_ROSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['STOP_ROSPEC_RESPONSE'] = {}
        self['STOP_ROSPEC_RESPONSE']['Type'] = 33
        self['STOP_ROSPEC_RESPONSE']['ID'] = 1


class ENABLE_ROSPEC(LLRPMessage):
    def __init__(self):
        self['ENABLE_ROSPEC'] = {}
        self['ENABLE_ROSPEC']['Type'] = 24
        self['ENABLE_ROSPEC']['ID'] = 1


class ENABLE_ROSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['ENABLE_ROSPEC_RESPONSE'] = {}
        self['ENABLE_ROSPEC_RESPONSE']['Type'] = 34
        self['ENABLE_ROSPEC_RESPONSE']['ID'] = 1


class DISABLE_ROSPEC(LLRPMessage):
    def __init__(self):
        self['DISABLE_ROSPEC'] = {}
        self['DISABLE_ROSPEC']['Type'] = 25
        self['DISABLE_ROSPEC']['ID'] = 1


class DISABLE_ROSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['DISABLE_ROSPEC_RESPONSE'] = {}
        self['DISABLE_ROSPEC_RESPONSE']['Type'] = 35
        self['DISABLE_ROSPEC_RESPONSE']['ID'] = 1


class GET_ROSPECS(LLRPMessage):
    def __init__(self):
        self['GET_ROSPECS'] = {}
        self['GET_ROSPECS']['Type'] = 26
        self['GET_ROSPECS']['ID'] = 1


class GET_ROSPECS_RESPONSE(LLRPMessage):
    def __init__(self):
        self['GET_ROSPECS_RESPONSE'] = {}
        self['GET_ROSPECS_RESPONSE']['Type'] = 36
        self['GET_ROSPECS_RESPONSE']['ID'] = 1


class ADD_ACCESSSPEC(LLRPMessage):
    def __init__(self):
        self['ADD_ACCESSSPEC'] = {}
        self['ADD_ACCESSSPEC']['Type'] = 40
        self['ADD_ACCESSSPEC']['ID'] = 1


class ADD_ACCESSSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['ADD_ACCESSSPEC_RESPONSE'] = {}
        self['ADD_ACCESSSPEC_RESPONSE']['Type'] = 50
        self['ADD_ACCESSSPEC_RESPONSE']['ID'] = 1


class DELETE_ACCESSSPEC(LLRPMessage):
    def __init__(self):
        self['DELETE_ACCESSSPEC'] = {}
        self['DELETE_ACCESSSPEC']['Type'] = 41
        self['DELETE_ACCESSSPEC']['ID'] = 1


class DELETE_ACCESSSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['DELETE_ACCESSSPEC_RESPONSE'] = {}
        self['DELETE_ACCESSSPEC_RESPONSE']['Type'] = 51
        self['DELETE_ACCESSSPEC_RESPONSE']['ID'] = 1


class ENABLE_ACCESSSPEC(LLRPMessage):
    def __init__(self):
        self['ENABLE_ACCESSSPEC'] = {}
        self['ENABLE_ACCESSSPEC']['Type'] = 42
        self['ENABLE_ACCESSSPEC']['ID'] = 1


class ENABLE_ACCESSSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['ENABLE_ACCESSSPEC_RESPONSE'] = {}
        self['ENABLE_ACCESSSPEC_RESPONSE']['Type'] = 52
        self['ENABLE_ACCESSSPEC_RESPONSE']['ID'] = 1


class DISABLE_ACCESSSPEC(LLRPMessage):
    def __init__(self):
        self['DISABLE_ACCESSSPEC'] = {}
        self['DISABLE_ACCESSSPEC']['Type'] = 43
        self['DISABLE_ACCESSSPEC']['ID'] = 1


class DISABLE_ACCESSSPEC_RESPONSE(LLRPMessage):
    def __init__(self):
        self['DISABLE_ACCESSSPEC_RESPONSE'] = {}
        self['DISABLE_ACCESSSPEC_RESPONSE']['Type'] = 53
        self['DISABLE_ACCESSSPEC_RESPONSE']['ID'] = 1


class GET_ACCESSSPECS(LLRPMessage):
    def __init__(self):
        self['GET_ACCESSSPECS'] = {}
        self['GET_ACCESSSPECS']['Type'] = 44
        self['GET_ACCESSSPECS']['ID'] = 1


class GET_ACCESSSPECS_RESPONSE(LLRPMessage):
    def __init__(self):
        self['GET_ACCESSSPECS_RESPONSE'] = {}
        self['GET_ACCESSSPECS_RESPONSE']['Type'] = 54
        self['GET_ACCESSSPECS_RESPONSE']['ID'] = 1


class GET_READER_CONFIG(LLRPMessage):
    def __init__(self):
        self['GET_READER_CONFIG'] = {}
        self['GET_READER_CONFIG']['Type'] = 2
        self['GET_READER_CONFIG']['ID'] = 1


class GET_READER_CONFIG_RESPONSE(LLRPMessage):
    def __init__(self):
        self['GET_READER_CONFIG_RESPONSE'] = {}
        self['GET_READER_CONFIG_RESPONSE']['Type'] = 12
        self['GET_READER_CONFIG_RESPONSE']['ID'] = 1


class SET_READER_CONFIG(LLRPMessage):
    def __init__(self):
        self['SET_READER_CONFIG'] = {}
        self['SET_READER_CONFIG']['Type'] = 3
        self['SET_READER_CONFIG']['ID'] = 1


class SET_READER_CONFIG_RESPONSE(LLRPMessage):
    def __init__(self):
        self['SET_READER_CONFIG_RESPONSE'] = {}
        self['SET_READER_CONFIG_RESPONSE']['Type'] = 13
        self['SET_READER_CONFIG_RESPONSE']['ID'] = 1


class CLOSE_CONNECTION(LLRPMessage):
    def __init__(self):
        self['CLOSE_CONNECTION'] = {}
        self['CLOSE_CONNECTION']['Type'] = 14
        self['CLOSE_CONNECTION']['ID'] = 1


class CLOSE_CONNECTION_RESPONSE(LLRPMessage):
    def __init__(self):
        self['CLOSE_CONNECTION_RESPONSE'] = {}
        self['CLOSE_CONNECTION_RESPONSE']['Type'] = 4
        self['CLOSE_CONNECTION_RESPONSE']['ID'] = 1


class GET_REPORT(LLRPMessage):
    def __init__(self):
        self['GET_REPORT'] = {}
        self['GET_REPORT']['Type'] = 60
        self['GET_REPORT']['ID'] = 1


class RO_ACCESS_REPORT(LLRPMessage):
    def __init__(self):
        self['RO_ACCESS_REPORT'] = {}
        self['RO_ACCESS_REPORT']['Type'] = 61
        self['RO_ACCESS_REPORT']['ID'] = 1


class KEEPALIVE(LLRPMessage):
    def __init__(self):
        self['KEEPALIVE'] = {}
        self['KEEPALIVE']['Type'] = 62
        self['KEEPALIVE']['ID'] = 1
...
class KEEPALIVE_ACK(LLRPMessage):
    def __init__(self):
        self['KEEPALIVE_ACK'] = {}
        self['KEEPALIVE_ACK']['Type'] = 72
        self['KEEPALIVE_ACK']['ID'] = 1


class READER_EVENT_NOTIFICATION(LLRPMessage):
    def __init__(self):
        self['READER_EVENT_NOTIFICATION'] = {}
        self['READER_EVENT_NOTIFICATION']['Type'] = 63
        self['READER_EVENT_NOTIFICATION']['ID'] = 1


class ENABLE_EVENTS_AND_REPORTS(LLRPMessage):
    def __init__(self):
        self['ENABLE_EVENTS_AND_REPORTS'] = {}
        self['ENABLE_EVENTS_AND_REPORTS']['Type'] = 64
        self['ENABLE_EVENTS_AND_REPORTS']['ID'] = 1


class ERROR_MESSAGE(LLRPMessage):
    def __init__(self):
        self['ERROR_MESSAGE'] = {}
        self['ERROR_MESSAGE']['Type'] = 100
        self['ERROR_MESSAGE']['ID'] = 1
